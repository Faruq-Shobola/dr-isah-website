    ...
    <div class="p-5">
        ...
        <?php endforeach;?>
            ...
            <a href="<?php the_permalink();?>" title="<?php the_title();?>" class="inline-block mb-3 text-2xl font-bold leading-6 transition-colors duration-200 hover:text-deep-purple-accent-700"><?php the_title();?></a>
